...
Ughlite.Default = {["Apply"] = UghAnm("isaacugh"), ["Remove"] = nil}
...
Trauma:AddTraumaCostumePack(Ughlite.Costumes, "Ugh", Ughlite.Default)
Ughlite:AddUghCostumePack(Ughlite.Costumes, "Ugh", Ughlite.Default)